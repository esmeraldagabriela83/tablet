console.log("hello from alphabetical js");
...
console.log("sortedPills length is:" , sortedPills.length);

let contentALphabetical=``;

//--------------------

const pills_container_alphabetical=document.getElementById("pills_container_alphabetical");

const alphabeticalSortBtn=document.getElementById("alphabeticalSortBtn");
alphabeticalSortBtn.addEventListener("click" , function(event){
    event.preventDefault()
    console.log("sort alphabetically");

    //----

    sortedPills.forEach(showSortedAllCallBackFunc);

    function showSortedAllCallBackFunc(item){
      contentALphabetical += `
      <div class="card" style="width: 18rem">
      <img src="${item.imgPill}" class="card-img-top" alt="pill_item_img_alphabetical">
      <div class="card-body">
    ...
    ///---
    pills_container_alphabetical.innerHTML=contentALphabetical;
});
